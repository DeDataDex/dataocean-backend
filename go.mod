module cosmosVideoApi

go 1.19

require github.com/stonemeta/beego v0.1.0

require (
	cosmossdk.io/simapp v0.0.0-20230105223759-512953cd689f
...
//replace dataocean => github.com/DeDataDex/dataocean v0.0.0-20230106092817-2d819fbfa673
replace github.com/cosmos/cosmos-sdk => github.com/xiaobo88michael/cosmos-sdk v1.0.0
